...
class LlavaMetaModel:
    ...
    def get_prompt_encoder(self):
        ...
        prompt_encoder = video_tower.prompt_encoder
...
class LlavaMetaForCausalLM(ABC):
    ...
    def encode_prompts(self, clicks):
        prompt_features = self.get_model().get_prompt_encoder()(clicks)
        return prompt_features
    
    def encode_rgbd_videos(self, images, depths, poses, intrinsics, lengths=None):
        ...
        video_features, batch_offset = self.get_model().get_video_tower()(image_features, depths, poses, intrinsics, lengths=lengths)  # (B, 1024, C)
    ...
    def prepare_inputs_labels_for_multimodal(
        ...
        images, depths, poses, intrinsics, lengths, clicks=None, image_sizes=None
    ):
        ...
        for batch_idx, cur_input_ids in enumerate(input_ids):
            ...
            if num_prompts == 0:
                cur_new_input_embeds = torch.cat([cur_new_input_embeds, prompt_features[0:0]], dim=0)
